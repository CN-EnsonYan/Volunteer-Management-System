...
<body onload="startMarquee()">
  <script>
     setTimeout(function(){window.location.href='/apps/vms/main/index.php?type=al&ref=https%3A%2F%2Fvolunteer.ensonyan.com%2Faccount%2Flogout%2Ffailed.php&token=FoqXwKt0T59jDXrP';},3000);
  </script>
<div class="errMainArea" >
	<div class="title" >系统提示 - System Alert</div>
	<div class="errTxtArea" style="border-left-style: solid;border-left-width: 0px;padding-left: 0px;padding-right: 0px;">
    <div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span><p class="txt_title">账户注销失败，请返回面板重试...</p></span></div></br><div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span>Log out failed, please try again...</span></div><div class="errBtmArea">
    <input type="button" class="btnFn1" value="Go now..." onclick="window.location.href='/apps/vms/main/index.php?type=al&ref=https%3A%2F%2Fvolunteer.ensonyan.com%2Faccount%2Flogout%2Ffailed.php&token=FoqXwKt0T59jDXrP'" />
  </div>
  </div>
