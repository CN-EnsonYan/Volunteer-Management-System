...
<body onload="startMarquee()">
  <script>
     setTimeout(function(){window.location.href='/apps/vms/account/login/index.html?ref=https%3A%2F%2Fvolunteer.ensonyan.com%2Faccount%2Flogout%2Fsuccess.php&token=FoqXwKt0T59jDXrP';},2800);
  </script>
<div class="errMainArea" >
    ...
    <div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span><p class="txt_title">账户注销成功，正在自动跳转...</p></span></div></br><div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span>Successfully Logged out, auto redirecting...</span></div><div class="errBtmArea">
    <input type="button" class="btnFn1" value="Go now..." onclick="window.location.href='/apps/vms/account/login/index.html?ref=https%3A%2F%2Fvolunteer.ensonyan.com%2Faccount%2Flogout%2Fsuccess.php&token=FoqXwKt0T59jDXrP'" />
  </div>
  </div>
