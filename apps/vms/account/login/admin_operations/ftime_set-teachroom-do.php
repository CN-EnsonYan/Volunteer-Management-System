...
// 获取修改的行政班
$setteachroom = safeStrings($_POST['setteachroom']);
$setteachroom2 = safeStrings($_POST['setteachroom2']);
$setteachroom3 = safeStrings($_POST['setteachroom3']);
$username = $_SESSION['entry_name'];
// 更新数据
mysql_query("UPDATE user SET teachroom='$setteachroom' WHERE username=$username",$link) or die('修改#1 TR数据出错：'.mysql_error());
mysql_query("UPDATE user SET teachroom2='$setteachroom2' WHERE username=$username",$link) or die('修改#2 TR数据出错：'.mysql_error());
mysql_query("UPDATE user SET teachroom3='$setteachroom3' WHERE username=$username",$link) or die('修改#3 TR数据出错：'.mysql_error());
