...
<body onload="startMarquee()">
  <script>
     setTimeout(function(){window.location.href='/apps/vms/main/index.php?ref=user_norm_panel&type=submit&token=FoqXwKt0T59jDXrP';},1600);
  </script>
<div class="errMainArea" >
    ...
    <input type="button" class="btnFn1" value="Go now..." onclick="window.location.href='/apps/vms/main/index.php?ref=user_norm_panel&type=submit&token=FoqXwKt0T59jDXrP'" />
  </div>
  </div>
