...
$getoldhomeroom=safeStrings($_POST['oldhomeroom']);
$getnewhomeroom=safeStrings($_POST['newhomeroom']);
...
mysql_set_charset('utf8',$link);
// 更新数据
mysql_query("UPDATE user SET homeroom = (REPLACE(homeroom,'$getoldhomeroom','$getnewhomeroom'));",$link) or die('修改数据出错：'.mysql_error()); 
