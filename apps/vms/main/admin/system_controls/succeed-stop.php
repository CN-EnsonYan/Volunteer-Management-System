...
<div class="errMainArea" >
    ...
    <p class="txt_title">VMS 系统功能停用成功，正在返回控制中心...</br><marquee direction=left scrolldelay=1>Account prohibiting succeessed, redirecting...</marquee></p></div><div class="errBtmArea">
