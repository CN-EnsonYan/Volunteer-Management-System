...
<head>
    <meta charset="UTF-8">
    <title>Change Teachroom / 修改执教班</title>
...
?>
  ...
  <div style="padding: 100px 100px 10px;">
	<form action="action-edit-teachroom.php" method="post" class="bs-example bs-example-form" role="form">
		...
		<div class="input-group">
			<span class="input-group-addon">New Teachroom #1 / 新执教班 #1</span>
			<select name="newteachroom">
                            <option value="Teachroom" style="display: none">Teachroom #1 选择执教班 #1</option>
		...
		<div class="input-group">
			<span class="input-group-addon">New Teachroom #2 / 新执教班 #2</span>
			<select name="newteachroom2">
                            <option value="无" style="display: none">Teachroom #2 选择执教班 #2</option>
							<option value="无">Clear This / 清除本条</option>
                            <option value="Pre10-01">Pre10-01</option>
                            <option value="Pre10-02">Pre10-02</option>
                            <option value="Pre10-03">Pre10-03</option>
                            <option value="1001">1001</option>
		...
		<div class="input-group">
			<span class="input-group-addon">New Teachroom #3 / 新执教班 #3</span>
			<select name="newteachroom3">
    ...
    <button type="submit" value="提交" class="btn btn-success active" onClick="return confirm('System Notice / 系统提示\u000d\u000dConfirm to change Teachroom? The wrong Teachroom will unbind the Counselor from Students.\u000d确认修改执教班吗?错误的执教班可能会使领事与学生丢失绑定关系。');">Submit / 提交</button>
	</form>
</div>
</body>
</html>