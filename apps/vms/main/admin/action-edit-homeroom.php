...
if ($_POST['newteachroom'] == 'Homeroom 选择行政班'){
  echo "<script>alert('System Notice / 系统提示\u000d\u000dPlease select Homeroom!\u000d请选择行政班！');</script>";
  echo "
        <script>
...
// 获取修改的行政班
$newhomeroom = safeStrings($_POST['newhomeroom']);
$uid = $_POST['uid'];
// 更新数据
mysql_query("UPDATE user SET homeroom='$newhomeroom' WHERE id=$uid",$link) or die('修改数据出错：'.mysql_error()); 
