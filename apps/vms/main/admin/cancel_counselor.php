...
$id = $_GET['id'];
// 更新数据
mysql_query("UPDATE user SET ls='no' WHERE id=$id",$link) or die('修改数据出错：'.mysql_error());
mysql_query("UPDATE user SET teachroom = null WHERE id=$id",$link) or die('修改数据出错：'.mysql_error());
