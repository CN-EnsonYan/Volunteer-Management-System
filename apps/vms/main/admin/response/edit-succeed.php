...
<div class="errMainArea" >
    ...
    <div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span><p class="txt_title">数据修改成功，正在返回控制中心...</p></span></div></br><div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span>Data modify succeessed, redirecting...</span></div><div class="errBtmArea">
    <input type="button" class="btnFn1" value="Go now..." onclick="window.location.href='/apps/vms/main/admin/index.php?ref=admin_auditingcenter_edit&token=FoqXwKt0T59jDXrP'" />
  </div>
  </div>
