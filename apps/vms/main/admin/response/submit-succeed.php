...
<body onload="startMarquee()">
  <script>
     setTimeout(function(){window.location.href='/apps/vms/main/admin/index.php?ref=user_norm_panel&type=submit&token=FoqXwKt0T59jDXrP';},1600);
  </script>
<div class="errMainArea" >
    ...
    <div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span><p class="txt_title">申请提交成功，正在返回用户中心...</p></span></div></br><div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span>Submit Successfully, auto redirecting...</span></div><div class="errBtmArea">
    <input type="button" class="btnFn1" value="Go now..." onclick="window.location.href='/apps/vms/main/admin/index.php?ref=admin_panel&type=submit&token=FoqXwKt0T59jDXrP'" />
  </div>
  </div>
