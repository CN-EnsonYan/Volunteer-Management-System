...
<div class="errMainArea" >
    ...
    <div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span><p class="txt_title">实名审核已通过成功，正在返回控制中心...</p></span></div></br><div class='mq' data-duration='2000' style='width:546px;overflow:hidden'><span>Real Name Auth confirm succeessed, redirecting...</span></div><div class="errBtmArea">
    <input type="button" class="btnFn1" value="Go now..." onclick="window.location.href=''.$_SERVER['HTTP_REFERER'].'" />
  </div>
  </div>
