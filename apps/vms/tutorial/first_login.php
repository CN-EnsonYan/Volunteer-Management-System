...
var lateHref;
function lvh() {
    mainF = setTimeout(function(){window.location.href='/apps/vms/tutorial/change_flstatus.php?from=tutorial_notice&flogin=false&token=FoqXwKt0T59jDXrP';},2000);
}
</script>
</HEAD>
...
<div class="errMainArea" >
    ...
    <div class='mq' data-duration='5000' style='width:546px;overflow:hidden'><span><p class="txt_title">欢迎使用VMS志愿者管理系统！鉴于第一次登陆，我们将会向您展示本系统的基本使用方法;点击下方的按钮进入教程哦~</p></span></div></br><div class='mq' data-duration='3500' style='width:546px;overflow:hidden'><span>Welcome here - The Volunteer Management System Developed by EnsonYan in class 6, it's your first time to enter here, come with me, I'll show you some tutorials about the whole VMS System ~ Click the button "Go Now" to enter the TUTORIAL.</span></div><div class="errBtmArea">
    <input type="button" class="btnFn1" value="Go now..." onclick="window.open('/apps/vms/tutorial/spdf_plugin/web/viewer.html?from=vms_user_main&flogin=true&token=FoqXwKt0T59jDXrP','PDF','height=950,width=700,top=0,right=0,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no'); lvh()" />
  </div>
  </div>
